...
public class GraphPanel extends JPanel {
    ...
    private Color zeroPointColor = new Color(15, 15, 200, 180); // point color
	...
	public GraphPanel(double[][] a, double[] zero) {
		...
		System.out.println(zeroPoints[2]);
		/////////////////////////////////////////////////////////
	}
	...
	public void paintComponent(Graphics g) {
		...
		System.out.println(getOrder_X("max") - getOrder_X("min"));
		double[][] zeroGraphPoints = new double[row][column];
		for (int i = 0; i < zeroPoints.length; i++) {
			System.out.println(zeroPoints[i]);
			int x1 = (int) (getWidth() - ((zeroPoints[i] + 15.45) * (getWidth() - padding * 2 - labelpadding)) / (getOrder_X("max") - getOrder_X("min")) + padding + labelpadding);
			int y1 = (int) (getHeight() - ((10 * (getHeight() - padding * 2 - labelpadding)) / 75 +  padding + labelpadding));
		...
		// - 1.0 ~ 6.5 => 75
		// 10 = 0
		int x_axis_0 = getHeight() - ((10 * (getHeight() - padding * 2 - labelpadding)) / 75 +  padding + labelpadding);
		g2.setColor(x_axisColor);
		g2.drawLine(padding + labelpadding ,x_axis_0, getWidth() - padding, x_axis_0);
